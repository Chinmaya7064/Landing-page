    ...
    <div className='w-full bg-white py-20'>
        <div className='md:max-w-[1170px] m-auto grid md:grid-cols-2 max-w-[400px]'>
            <div className='flex flex-col justify-start gap-4'>
                ...
                <h1 className='md:leading-[55px] py-2 md:text-5xl text-5xl font-semibold'>Access To <span className='text-[#20B486]'>5000+</span> Courses from <span className='text-[#20B486]'>3000</span> Instructors & Institutions</h1>
